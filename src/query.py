...
Examples:
    python query.py fastprotein.tsv 'SELECT * FROM data LIMIT 10'
    python query.py fastprotein.tsv 'SELECT Entry, Mass FROM data WHERE Mass > 50000'
    python query.py fastprotein.tsv 'SELECT COUNT(*) FROM data'
"""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog='''
Examples:
  %(prog)s fastprotein.tsv 'SELECT * FROM data LIMIT 10'
  %(prog)s fastprotein.tsv 'SELECT Entry, Mass FROM data WHERE Mass > 50000'
  %(prog)s fastprotein.tsv 'SELECT COUNT(*) FROM data'
  %(prog)s fastprotein.tsv --info  # Show table structure
        '''
    )
